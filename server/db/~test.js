...
// 03 mongoose.connect(uri).then(
// 03     () => { 
// 03         /** ready to use. The `mongoose.connect()` promise resolves to undefined. */ 
// 03         console.log('Connected to Mongo');
// 03        
// 03     },
// 03     err => {
// 03          /** handle initial connection error */ 
// 03          console.log('error connecting to Mongo: ')
// 03          console.log(err);
// 03        
// 03         }
// 03   );
